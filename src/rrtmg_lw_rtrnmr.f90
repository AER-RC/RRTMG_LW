...
! Declarations for cloud overlap adjustment
      real(kind=jprb) :: faccld1(mxlay+1),faccld2(mxlay+1)
      real(kind=jprb) :: facclr1(mxlay+1),facclr2(mxlay+1)
      real(kind=jprb) :: faccmb1(mxlay+1),faccmb2(mxlay+1)
      real(kind=jprb) :: faccld1d(0:mxlay),faccld2d(0:mxlay)
      real(kind=jprb) :: facclr1d(0:mxlay),facclr2d(0:mxlay)
      real(kind=jprb) :: faccmb1d(0:mxlay),faccmb2d(0:mxlay)
      ...
      integer(kind=jpim) :: istcld(mxlay+1),istcldd(0:mxlay)
