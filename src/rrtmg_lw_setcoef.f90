...
! Local
      ...
      real(kind=jprb) :: stpfac, tbndfrac, t0frac, tlayfrac, tlevfrac
      real(kind=jprb) :: dbdtlev, dbdtlay
      real(kind=jprb) :: plog, fp, ft, ft1, water, scalefac, factor, compfp
      ...
      tbndfrac = tbound - 159._jprb - float(indbound)
      ...
      t0frac = tz(0) - 159._jprb - float(indlev0)
      laytrop = 0
...
!  surface, level, and layer temperatures.
      do lay = 1, nlayers
         indlay = tavel(lay) - 159._jprb
         if (indlay .lt. 1) then
            indlay = 1
         elseif (indlay .gt. 180) then
            indlay = 180
         endif
         tlayfrac = tavel(lay) - 159._jprb - float(indlay)
         indlev = tz(lay) - 159._jprb
         if (indlev .lt. 1) then
            indlev = 1
         elseif (indlev .gt. 180) then
            indlev = 180
         endif
         tlevfrac = tz(lay) - 159._jprb - float(indlev)
...
!  in the calculation of absorption coefficient
         ...
         factor = (tavel(lay)-180.8_jprb)/7.2_jprb
...
!  Calculate needed column amounts.
         ...
         colco(lay) = 1.e-20_jprb * wkl(5,lay)
         ...
         if (colo3(lay) .eq. 0._jprb) colo3(lay) = 1.e-32_jprb * coldry(lay)
         if (coln2o(lay) .eq. 0._jprb) coln2o(lay) = 1.e-32_jprb * coldry(lay)
         if (colco(lay) .eq. 0._jprb) colco(lay) = 1.e-32_jprb * coldry(lay)
         if (colch4(lay) .eq. 0._jprb) colch4(lay) = 1.e-32_jprb * coldry(lay)
         colbrd(lay) = 1.e-20_jprb * wbroad(lay)
         go to 5400
...
!***************************************************************************
      ...
      0.16823e-06_jprb/)
      totplk16(1:50) = (/ &
      0.28481e-12_jprb,0.33159e-12_jprb,0.38535e-12_jprb,0.44701e-12_jprb,0.51763e-12_jprb, &
      0.59836e-12_jprb,0.69049e-12_jprb,0.79549e-12_jprb,0.91493e-12_jprb,0.10506e-11_jprb, &
      0.12045e-11_jprb,0.13788e-11_jprb,0.15758e-11_jprb,0.17984e-11_jprb,0.20493e-11_jprb, &
      0.23317e-11_jprb,0.26494e-11_jprb,0.30060e-11_jprb,0.34060e-11_jprb,0.38539e-11_jprb, &
      0.43548e-11_jprb,0.49144e-11_jprb,0.55387e-11_jprb,0.62344e-11_jprb,0.70086e-11_jprb, &
      0.78692e-11_jprb,0.88248e-11_jprb,0.98846e-11_jprb,0.11059e-10_jprb,0.12358e-10_jprb, &
      0.13794e-10_jprb,0.15379e-10_jprb,0.17128e-10_jprb,0.19055e-10_jprb,0.21176e-10_jprb, &
      0.23508e-10_jprb,0.26070e-10_jprb,0.28881e-10_jprb,0.31963e-10_jprb,0.35339e-10_jprb, &
      0.39034e-10_jprb,0.43073e-10_jprb,0.47484e-10_jprb,0.52299e-10_jprb,0.57548e-10_jprb, &
      0.63267e-10_jprb,0.69491e-10_jprb,0.76261e-10_jprb,0.83616e-10_jprb,0.91603e-10_jprb/)
      totplk16(51:100) = (/ &
      0.10027e-09_jprb,0.10966e-09_jprb,0.11983e-09_jprb,0.13084e-09_jprb,0.14275e-09_jprb, &
